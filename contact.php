                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <form action="insert.php" class="">
                                ...
                                <textarea  type="text" class="w-100 form-control border-0 mb-4" rows="5" cols="10" name="message" id="message" placeholder="Your Message"></textarea>
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">477,Marutidham,Amroli.Surat</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2">zalakpatel@example.com</p>
                                </div>
                            </div>
